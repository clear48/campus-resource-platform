...
当前事实快照基于 `dev` 分支提交 `400b99fe`，核对日期为 2026-07-28。仓库中可直接核验到 12 个 Controller、28 个 REST 接口方法、9 张 MySQL 表、9 个 MyBatis Mapper；现有 Surefire 报告记录 124 个测试、0 失败、0 错误。
