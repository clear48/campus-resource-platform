...
- `frontend/` 已完成第一阶段：T01 工程骨架、T02 Element Plus、T03 Router 与最小页面壳；当前不得提前执行 T05 或后续任务。
...
2. 找到第一个 `TODO`：当前为 `T04`。
3. 仅执行 T04；完成测试、更新计划/队列/状态文档、提交并推送后，才继续 T05。
