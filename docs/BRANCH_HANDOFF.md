...
| 当前前端任务 | `T03`：接入 Vue Router 和最小页面壳 |
...
- `frontend/` 已完成 T01 工程骨架和 T02 Element Plus 接入；当前不得提前执行 T04 或后续任务。
...
2. 找到第一个 `TODO`：当前为 `T03`。
3. 仅执行 T03；完成测试、更新计划/队列/状态文档、提交并推送后，才继续 T04。
