...
| 当前前端状态 | 已完成 T01-T28：基础、认证、公开浏览、收藏下载、资料创建和我的上传页面；正在执行 T29：我的收藏 API |
| 当前自动队列 | `docs/frontend/05-frontend-task-queue.md`，当前执行任务为 `T29` |
